                ...
                <div className="col-12 shadow p-3 mb-5 bg-white rounded mt-5 txtcostos">
                    ...
                    <h1>Costos</h1>
                        <div className="row align-items-start">
                            ...
                            pero el estimado es que produzca electricidad de 8 a 10 bombillas.</p>
                            <br/>
                        ...
                        <div className="col border ps-3 pt-2">
                            ...
                            pero el estimado es que produzca electricidad de 4 a 6 bombillas.</p>
                            <br/>
                        ...
                        <p>Tiene capacidad para 25 plantas, de las cuales depende mucho el tipo de planta que se utilice
                            pero el estimado es que produzca electricidad de 1 a 2 bombillas.</p>
                        <br/>
